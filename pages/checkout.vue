    ...
    <section class="py-8 mx-auto antialiased bg-white dark:bg-gray-900 md:py-16 max-w-7xl">
      <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 md:col-span-8">
          ...
          <div v-if="step === 1">
            <!-- Checkout Form -->
            <form action="#" class="max-w-screen-xl px-4 mx-auto 2xl:px-0" @submit.prevent="goToPaymentForm">
          ...
          <div v-if="step === 2">
            <!-- Payment Form -->
            <form action="#" class="max-w-screen-xl px-4 mx-auto 2xl:px-0" @submit.prevent="submitPayment">
              <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
                <div class="flex-1 min-w-0 space-y-8">
                  <div class="space-y-4">
              ...
              <div class="flex justify-end mt-6 space-s-3">
                ...
                <button type="submit"
                  class="items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Pay
                  Now</button>
              </div>
            </form>
          </div>
        ...
        <div class="col-span-12 md:col-span-4">
          <div class="w-full mt-6 space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
            ...
            <div class="space-y-3">
              <nuxt-link to="/order-summary" type="submit"
