<template>
  <div>
    ...
    <footer class="text-center text-white bg-black lg:text-left">
      <!-- <div class="flex items-center justify-center p-6 border-b-2 border-neutral-100 lg:justify-between">
      ...
      <!--Copyright section-->
      <div class="p-6 border-t-2 bg-black/5 border-neutral-100">
        <div class="grid grid-cols-1 gap-4 p-6 md:grid-cols-2">
          <div class="flex items-center space-x-4">
            <p>Sign up for our Newsletter</p>
            <div class="relative">
              <input type="email" placeholder="Your email address"
                class="p-2 pr-10 text-gray-800 rounded-md outline-none focus:ring-2 focus:ring-blue-300" />
